# AWS Certified Generative AI Developer Professional — 学習ノート（日本語）

このディレクトリは、AWS Certified Generative AI Developer Professional の練習問題を
日本語に翻訳し、正解と解説をまとめた学習資料です。
...
> 注記: 本資料は学習目的の個人メモです。AWS の公式ドキュメントを必ず併せて確認してください。
